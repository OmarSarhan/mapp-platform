...
export const MCP_CLIENT_PRESETS=[
 ...
 {id:'authoring',label:'Read and propose',scopes:['mcp:connect','inspect','derive','semantic:inspect','propose','semantic:propose'],help:'Everything the analysis preset reads, plus the ability to add to the review queue. An agent with this can draft a change and have it checked, but not apply one -- applying is a separate scope and a separate decision.'},
