...
| MCP runtime | `mapp-mcp`: the official Python SDK behind a protocol-era guard, 5 read-only tools, RFC 9728 metadata, token-A authentication per call |
...
| Operation allowlist | 7 of the platform's 53 actions |
