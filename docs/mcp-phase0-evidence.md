...
| MCP runtime | `mapp-mcp`: the official Python SDK behind a protocol-era guard, 13 read-only tools, RFC 9728 metadata, token-A authentication per call |
...
| Operation allowlist | 14 of the platform's 54 actions |
